...
% you are plotting with black and white, no reason to plot more than 4
% lines...
bwplot(abs([t' t' t' t' t' t' t' t']), ...
       abs([y_1' y_2' y_3' y_4' y_1' y_2' y_3' y_4']), ...
       15, 12, ...
       'Time (s)', '$y_n(t)$', ...
       {'$y_1(t)$', '$y_2(t)$', '$y_3(t)$', '$y_4(t)$', ...
        '$y_5(t)$', '$y_6(t)$', '$y_7(t)$', '$y_8(t)$'})
